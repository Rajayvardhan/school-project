...
// import Index from "../../Particals/General/index";
import EarningsCard from "../../Particals/General/EarningsCard";
                ...
                <div className="card profile-greeting">
                  ...
                  <div className="card-body text-center p-t-0">
                    ...
                    <p>
                      ...
                      visite this dashboard. we will be happy to help you grow
                      your business. */}
                    </p>
                    ...
                    <div className="code-box-copy">
                      ...
                      <pre>
                        {/* <code className="language-html" id="profile-greeting">
                          ...
                          &lt;div className="card profile-greeting"&gt; &lt;div
                          className="card-header"&gt; &lt;div
                          className="header-top"&gt; &lt;div
                          className="setting-list bg-primary"&gt; &lt;ul
                          className="list-unstyled setting-option"&gt;
                          &lt;li&gt;&lt;div className="setting-white"&gt;&lt;i
                          className="icon-settings"&gt;&lt;/i&gt;&lt;/div&gt;&lt;/li&gt;
                          &lt;li&gt;&lt;i className="view-html fa fa-code
                          font-white"&gt;&lt;/i&gt;&lt;/li&gt; &lt;li&gt;&lt;i
                          className="icofont icofont-maximize full-card
                          font-white"&gt;&lt;/i&gt;&lt;/li&gt; &lt;li&gt;&lt;i
                          className="icofont icofont-minus minimize-card
                          font-white"&gt;&lt;/i&gt;&lt;/li&gt; &lt;li&gt;&lt;i
                          className="icofont icofont-refresh reload-card
                          font-white"&gt;&lt;/i&gt;&lt;/li&gt; &lt;li&gt;&lt;i
                          className="icofont icofont-error close-card
                          font-white"&gt; &lt;/i&gt;&lt;/li&gt; &lt;/ul&gt;
                          &lt;/div&gt; &lt;/div&gt; &lt;/div&gt; &lt;div
                          className="card-body text-center"&gt; &lt;h3
                          className="font-light"&gt;Wellcome Back,
                          John!!&lt;/h3&gt; &lt;p&gt;Lorem ipsum is simply dummy
                          text of the printing and typesetting industry.Lorem
                          ipsum has been&lt;/p&gt; &lt;button className="btn
                          btn-light"&gt;Update &lt;/button&gt; &lt;/div&gt;
                          &lt;/div&gt;
                        </code> */}
                      </pre>
                    </div>
              ...
              <div className="col-xl-6 col-md-3 col-sm-6 box-col-3 des-xl-25 rate-sec">
                <div className="card income-card card-primary">
                  <div className="card-body text-center">
                    ...
                    <h5>8,50,49</h5>
                    <p>Total Students</p>
                    <a className="btn-arrow arrow-primary">
              ...
              <div className="col-xl-6 col-md-3 col-sm-6 box-col-3 des-xl-25 rate-sec">
                <div className="card income-card card-secondary">
                  <div className="card-body text-center">
                    ...
                    <a className="btn-arrow arrow-secondary">
            ...
            <div className="card income-card">
              <div className="card-header">
                <div className="header-top d-sm-flex align-items-center">
                  <h5>Admissions overview</h5>
                  <div className="center-content">
                    <p className="d-sm-flex align-items-center">
                      <span className="font-primary m-r-10 f-w-700">
                        $859.25k
                      </span>
                      <i className="toprightarrow-primary fa fa-arrow-up m-r-10"></i>
              ...
              <div className="card-body p-0">
                ...
                <div className="code-box-copy">
                  ...
                  <pre>
                    {/* <code className="language-html" id="yearly-overview">
                      &lt;div className="card income-card"&gt; &lt;div
                      className="card-header"&gt; &lt;div className="header-top
                      d-sm-flex align-items-center"&gt; &lt;h5&gt; yearly
                      overview &lt;/h5&gt; &lt;div className="center-content"
                      &gt; &lt;p&gt; &lt;span className="font-primary
                      fontbold-600" &gt; $859.25k &lt;/span&gt; &lt;i
                      className="toprightarrow-primary fa fa-arrow-up m-l-10
                      m-r-10" &gt; &lt;/i&gt; 86% More than last year &lt;/p&gt;
                      &lt;/div&gt; &lt;div className="setting-list"&gt; &lt;ul
                      className="list-unstyled setting-option"&gt;
                      &lt;li&gt;&lt;div className="setting-primary"&gt;&lt;i
                      className="icon-settings"&gt;&lt;/i&gt;&lt;/div&gt;&lt;/li&gt;
                      &lt;li&gt;&lt;i className="view-html fa fa-code
                      font-primary"&gt;&lt;/i&gt;&lt;/li&gt; &lt;li&gt;&lt;i
                      className="icofont icofont-maximize full-card
                      font-primary"&gt;&lt;/i&gt;&lt;/li&gt; &lt;li&gt;&lt;i
                      className="icofont icofont-minus minimize-card
                      font-primary"&gt;&lt;/i&gt;&lt;/li&gt; &lt;li&gt;&lt;i
                      ...
                      font-primary"&gt;&lt;/i&gt;&lt;/li&gt; &lt;li&gt;&lt;i
                      className="icofont icofont-error close-card
                      font-primary"&gt; &lt;/i&gt;&lt;/li&gt; &lt;/ul&gt;
                      &lt;/div&gt; &lt;/div&gt; &lt;/div&gt; &lt;div
                      className="card-body p-0"&gt; &lt;div
                      id="chart-timeline-dashbord"&gt;&lt;/div&gt; &lt;/div&gt;
                      &lt;/div&gt;
                    </code> */}
                  </pre>
                </div>
                ...
                <div className="card">
                  ...
                  <div className="card-body p-0">
                    ...
                    <div className="code-box-copy">
                      ...
                      <pre>
                        {/* <code className="language-html" id="sell-overview">
                          
                          &lt;div className="card"&gt; &lt;div
                          className="card-header"&gt; &lt;div
                          className="header-top d-sm-flex
                          align-items-center"&gt; &lt;h5&gt; Sell Overview
                          &lt;/h5&gt; &lt;div className="center-content" &gt;
                          &lt;p className="d-flex align-items-center"&gt; &lt;i
                          className="toprightarrow-primary fa fa-arrow-up me-2"
                          &gt; &lt;/i&gt; 86% Growth &lt;/p&gt; &lt;/div&gt;
                          &lt;div className="setting-list"&gt; &lt;ul
                          className="list-unstyled setting-option"&gt;
                          &lt;li&gt;&lt;div className="setting-primary"&gt;&lt;i
                          className="icon-settings"&gt;&lt;/i&gt;&lt;/div&gt;&lt;/li&gt;
                          &lt;li&gt;&lt;i className="view-html fa fa-code
                ...
                <div className="card latest-update-sec">
                  ...
                  <div className="card-body">
                    ...
                    <div className="code-box-copy">
                      ...
                      <pre>
                        {/* <code className="language-html" id="latest-update-sec">
                          
                          &lt;div className="card latest-update-sec"&gt; &lt;div
                          className="card-header"&gt; &lt;div
                          className="header-top d-sm-flex
                          align-items-center"&gt; &lt;h5&gt; Latest Update
                          &lt;/h5&gt; &lt;div className="center-content" &gt;
                          &lt;ul className="week-date" &gt; &lt;li
                          className="font-primary"&gt; Today &lt;/li&gt; &lt;li
                          &gt; Month &lt;/li&gt; &lt;/ul&gt; &lt;/div&gt;
                          &lt;div className="setting-list"&gt; &lt;ul
                          className="list-unstyled setting-option"&gt;
                          &lt;li&gt;&lt;div className="setting-primary"&gt;&lt;i
                          ...
                          font-primary"&gt; &lt;/i&gt;&lt;/li&gt; &lt;/ul&gt;
                          &lt;/div&gt; &lt;/div&gt; &lt;/div&gt; &lt;div
                          className="card-body px-0"&gt; &lt;div
                          className="table-responsive"&gt; &lt;table
                          className="table table-bordernone"&gt; &lt;tbody&gt;
                          &lt;tr&gt; &lt;td&gt; &lt;div className="media"&gt;
                          &lt;svg version="1.1"
                          xmlns="http://www.w3.org/2000/svg"
                          ...
                          &lt;/g&gt; &lt;/g&gt; &lt;/svg&gt; &lt;div
                          className="media-body"&gt; &lt;span&gt; Google project
                          Apply Review&lt;/span&gt; &lt;p&gt; Complete in 3
                          Hours&lt;/p&gt; &lt;/div&gt; &lt;/div&gt; &lt;/td&gt;
                          &lt;td&gt; &lt;a href='index.html' target='_blank'&gt;
                          Edit &lt;/a&gt; &lt;/td&gt; &lt;td&gt; &lt;a
                          href='index.html' target='_blank'&gt; Detete
                          &lt;/a&gt; &lt;/td&gt; &lt;/tr&gt; &lt;tr&gt;
                          &lt;td&gt; &lt;div className="media"&gt; &lt;svg
                          enableBackground="new 0 0 512 512" viewBox="0 0 512
                          512" xmlns="http://www.w3.org/2000/svg"&gt; &lt;path
                          d="m362 91v-60h-212v60h-150v390h512c0-16.889 0-372.29
                          0-390zm-182-30h152v30h-152zm302 390h-452v-202.844l90
                          ...
                          0-84.634 0-94.844h452z"&gt;&lt;/path&gt; &lt;/svg&gt;
                          &lt;div className="media-body"&gt; &lt;span&gt;
                          Business Logo Create&lt;/span&gt; &lt;p&gt; Complete
                          in 2 Days&lt;/p&gt; &lt;/div&gt; &lt;/div&gt;
                          ...
                          &lt;td&gt; &lt;div className="media"&gt; &lt;svg
                          enableBackground="new 0 0 512 512" viewBox="0 0 512
                          512" xmlns="http://www.w3.org/2000/svg"&gt; &lt;g&gt;
                          &lt;path d="m345.622
                          126.038c-50.748-45.076-130.482-46.914-183.244
                          3.903-21.262 20.478-35.375 47.381-39.737 75.754-5.454
                          35.471 2.872 70.834 23.444 99.576 56.271 78.616 49.132
                          141.058 49.915 145.691 0 16.435 6.211 31.795 17.491
                          43.253 11.289 11.469 26.386 17.785 42.509 17.785
                          33.084 0 60-26.916 60-60 .686-4.269-6.11-72.81
                          47.676-143.691 17.875-23.557 27.324-51.673
                          27.324-81.309
                          0-38.547-16.54-75.347-45.378-100.962zm-89.622
                          355.962c-16.486 0-29.462-13.096-29.975-30h59.975c0
                          16.542-13.458 30-30 30zm83.777-191.826c-30.015
                          ...
                          7.293-47.43 49.733-88.262 103.846-88.262 58.661 0
                          104.861 47.891 104.861 105.008 0 23.032-7.339
                          44.877-21.223 63.174z"&gt;&lt;/path&gt;
                          <br />
                          &lt;path d="m256 62c8.284 0 15-6.716
                          15-15v-32c0-8.284-6.716-15-15-15s-15 6.716-15 15v32c0
                          8.284 6.716 15 15 15z"&gt;&lt;/path&gt;
                          <br />
                          &lt;path d="m419.385 149.99 25.98-15c7.174-4.142
                          9.632-13.316
                          5.49-20.49-4.142-7.175-13.316-9.633-20.49-5.49l-25.98
                          15c-7.174 4.142-9.632 13.316-5.49 20.49 4.162 7.21
                          13.349 9.613 20.49 5.49z"&gt;&lt;/path&gt;
                          <br />
                          &lt;path d="m92.615 304.01-25.98 15c-7.174 4.142-9.632
                          13.316-5.49 20.49 4.163 7.21 13.35 9.613 20.49
                          5.49l25.98-15c7.174-4.142 9.632-13.316
                          5.49-20.49-4.141-7.175-13.316-9.632-20.49-5.49z"&gt;&lt;/path&gt;
                          <br />
                          &lt;path d="m338.5 84.105c7.141 4.124 16.33 1.716
                          20.49-5.49l15-25.98c4.142-7.174
                          1.684-16.348-5.49-20.49-7.174-4.144-16.349-1.685-20.49
                          5.49l-15 25.98c-4.142 7.175-1.684 16.348 5.49
                          20.49z"&gt;&lt;/path&gt;
                          <br />
                          &lt;path d="m153.01 78.615c4.163 7.21 13.35 9.613
                          20.49 5.49 7.174-4.142 9.632-13.316
                          ...
                          5.49-4.142 7.174-1.684 16.348 5.49 20.49l25.98
                          15c7.141 4.124 16.33 1.716 20.49-5.49 4.143-7.174
                          1.685-16.348-5.49-20.49z"&gt;&lt;/path&gt;
                          <br />
                          &lt;path d="m107.615
                          124.01-25.98-15c-7.175-4.144-16.348-1.684-20.49
                          5.49s-1.684 16.348 5.49 20.49l25.98 15c7.141 4.124
                          16.33 1.716 20.49-5.49 4.143-7.174
                          1.685-16.348-5.49-20.49z"&gt;&lt;/path&gt;
                          <br />
                          &lt;path d="m466 212h-30c-8.284 0-15 6.716-15 15s6.716
                          15 15 15h30c8.284 0 15-6.716
                          15-15s-6.716-15-15-15z"&gt;&lt;/path&gt;
                          <br />
                          &lt;path d="m91 227c0-8.284-6.716-15-15-15h-30c-8.284
                          0-15 6.716-15 15s6.716 15 15 15h30c8.284 0 15-6.716
                          15-15z"&gt;&lt;/path&gt;
                          <br />
                          &lt;path d="m275.394 216.394-19.394
                          19.393-19.394-19.393c-5.857-5.858-15.355-5.858-21.213
                          0s-5.858 15.355 0 21.213l25.607 25.606v53.787c0 8.284
                          6.716 15 15 15s15-6.716
                          15-15v-53.787l25.606-25.606c5.858-5.858 5.858-15.355
                          0-21.213-5.857-5.859-15.355-5.859-21.212
                          0z"&gt;&lt;/path&gt; &lt;/g&gt; &lt;/svg&gt; &lt;div
                          className="media-body"&gt; &lt;span&gt; Business
                          Project Research&lt;/span&gt; &lt;p&gt; Due in 1
                          hour&lt;/p&gt; &lt;/div&gt; &lt;/div&gt; &lt;/td&gt;
                          &lt;td&gt; &lt;a href='index.html' target='_blank'&gt;
                          Edit &lt;/a&gt; &lt;/td&gt; &lt;td&gt; &lt;a
                          href='index.html' target='_blank'&gt; Detete
                          ...
                          enableBackground="new 0 0 512 512" viewBox="0 0 512
                          512" xmlns="http://www.w3.org/2000/svg"&gt; &lt;g&gt;
                          &lt;path d="m512 390v-390h-512v390h241v32h-15c-41.355
                          0-75 33.645-75
                          75v15h210v-15c0-41.355-33.645-75-75-75h-15v-32zm-226
                          62c19.556 0 36.239 12.539 42.43
                          30h-144.86c6.191-17.461 22.874-30
                          42.43-30zm-256-92v-330h452v330c-12.164 0-438.947 0-452
                          0z"&gt;&lt;/path&gt; &lt;path d="m136 180c24.813 0
                          45-20.187 45-45s-20.187-45-45-45-45 20.187-45 45
                          20.187 45 45 45zm0-60c8.271 0 15 6.729 15 15s-6.729
                          15-15 15-15-6.729-15-15 6.729-15
                          15-15z"&gt;&lt;/path&gt;
                          <br />
                          &lt;path d="m184.568
                          ...
                          72.152h-90v-11.789c0-23.666 16.049-44.122
                          37.332-47.584 13.509-2.198 26.578 1.38 36.801 10.074
                          10.083 8.577 15.867 21.078 15.867
                          34.299z"&gt;&lt;/path&gt; &lt;path d="m241
                          270h120v30h-120z"&gt;&lt;/path&gt; &lt;path d="m241
                          210h210v30h-210z"&gt;&lt;/path&gt; &lt;path d="m241
                          150h210v30h-210z"&gt;&lt;/path&gt; &lt;path d="m331
                          90h120v30h-120z"&gt;&lt;/path&gt; &lt;path d="m241
                          90h60v30h-60z"&gt;&lt;/path&gt; &lt;path d="m391
                          270h60v30h-60z"&gt;&lt;/path&gt; &lt;/g&gt;
                          &lt;/svg&gt; &lt;div className="media-body"&gt;
                          &lt;span&gt; Recruitment in IT Depertment&lt;/span&gt;
                          &lt;p&gt; Complete in 3 Hours&lt;/p&gt; &lt;/div&gt;
                          &lt;/div&gt; &lt;/td&gt; &lt;td&gt; &lt;a
                          href='index.html' target='_blank'&gt; Edit &lt;/a&gt;
                          &lt;/td&gt; &lt;td&gt; &lt;a href='index.html'
                          target='_blank'&gt; Detete &lt;/a&gt; &lt;/td&gt;
                          &lt;/tr&gt; &lt;tr&gt; &lt;td&gt; &lt;div
                          className="media"&gt; &lt;svg version="1.1"
                          xmlns="http://www.w3.org/2000/svg"
                          xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
                          ...
                          &lt;/g&gt; &lt;/g&gt; &lt;/svg&gt; &lt;div
                          className="media-body"&gt; &lt;span&gt; Submit
                          Riverfront Project&lt;/span&gt; &lt;p&gt; Complete in
                          2 Days&lt;/p&gt; &lt;/div&gt; &lt;/div&gt; &lt;/td&gt;
                          &lt;td&gt; &lt;a href='index.html' target='_blank'&gt;
                          Edit &lt;/a&gt; &lt;/td&gt; &lt;td&gt; &lt;a
                          href='index.html' target='_blank'&gt; Detete
                ...
                <div className="card">
                  <div className="card-body">
                    ...
                    <div className="code-box-copy">
                      ...
                      <pre>
                        {/* <code className="language-html" id="recent-order">
                          &lt;div className="card"&gt; &lt;div
                          className="card-body"&gt; &lt;div
                          className="table-responsive"&gt; &lt;table
                          className="table table-bordernone"&gt; &lt;thead&gt;
                          &lt;tr&gt; &lt;th&gt;Name&lt;/th&gt;
                          &lt;th&gt;Date&lt;/th&gt;
                          &lt;th&gt;Quantity&lt;/th&gt;
                          &lt;th&gt;Value&lt;/th&gt; &lt;th&gt;Rate&lt;/th&gt;
                          &lt;th&gt; &lt;div className="setting-list"&gt; &lt;ul
                          className="list-unstyled setting-option"&gt;
                          &lt;li&gt; &lt;div
                          className="setting-primary"&gt;&lt;i
                          className="icon-settings"&gt; &lt;/i&gt;&lt;/div&gt;
                          &lt;/li&gt; &lt;li&gt;&lt;i className="view-html fa
                          fa-code font-primary"&gt;&lt;/i&gt;&lt;/li&gt;
                          ...
                          className="media-body"&gt; &lt;span&gt;Yellow New Nike
                          shoes&lt;/span&gt; &lt;/div&gt; &lt;/div&gt;
                          &lt;/td&gt; &lt;td&gt; &lt;p&gt;16 August&lt;/p&gt;
                          &lt;/td&gt; &lt;td&gt; &lt;p&gt;54146&lt;/p&gt;
                          &lt;/td&gt; &lt;td&gt; &lt;img className="img-fluid"
                          src="../assets/images/dashboard/graph-1.png" alt=""
                          data-original-title="" title=""&gt; &lt;/td&gt;
                          &lt;td&gt; &lt;p&gt;$210326&lt;/p&gt; &lt;/td&gt;
                          &lt;td&gt; &lt;p&gt;Done&lt;/p&gt; &lt;/td&gt;
                          &lt;/tr&gt; &lt;tr&gt; &lt;td&gt; &lt;div
                          className="media"&gt; &lt;img className="img-fluid
                          rounded-circle"
                          src="../assets/images/dashboard/product-2.png" alt=""
                          data-original-title="" title=""&gt; &lt;div
                          className="media-body"&gt; &lt;span&gt;Sony Brand New
                          Headphone&lt;/span&gt; &lt;/div&gt; &lt;/div&gt;
                          &lt;/td&gt; &lt;td&gt; &lt;p&gt;2 October&lt;/p&gt;
                          &lt;/td&gt; &lt;td&gt; &lt;p&gt;32015&lt;/p&gt;
                          &lt;/td&gt; &lt;td&gt; &lt;img className="img-fluid"
                          ...
                          data-original-title="" title=""&gt; &lt;div
                          className="media-body"&gt; &lt;span&gt;Beautiful
                          Golden Tree plant&lt;/span&gt; &lt;/div&gt;
                          &lt;/div&gt; &lt;/td&gt; &lt;td&gt; &lt;p&gt;21
                          March&lt;/p&gt; &lt;/td&gt; &lt;td&gt;
                          &lt;p&gt;12548&lt;/p&gt; &lt;/td&gt; &lt;td&gt;
                          ...
                          data-original-title="" title=""&gt; &lt;div
                          className="media-body"&gt; &lt;span&gt;Marco M Kely
                          Handbeg&lt;/span&gt; &lt;/div&gt; &lt;/div&gt;
                          &lt;/td&gt; &lt;td&gt; &lt;p&gt;31 December&lt;/p&gt;
                          &lt;/td&gt; &lt;td&gt; &lt;p&gt;15495&lt;/p&gt;
                          &lt;/td&gt; &lt;td&gt; &lt;img className="img-fluid"
                          ...
                          data-original-title="" title=""&gt; &lt;div
                          className="media-body"&gt; &lt;span&gt;Being Human
                          Branded T-Shirt&lt;/span&gt; &lt;/div&gt; &lt;/div&gt;
                          &lt;/td&gt; &lt;td&gt; &lt;p&gt;26 January&lt;/p&gt;
                          &lt;/td&gt; &lt;td&gt; &lt;p&gt;56625&lt;/p&gt;
                          &lt;/td&gt; &lt;td&gt; &lt;img className="img-fluid"
                ...
                <div className="card">
                  ...
                  <div className="card-body p-0">
                    ...
                    <div className="code-box-copy">
                      ...
                      <pre>
                        {/* <code className="language-html" id="user-activations">
                          &lt;div className="card"&gt; &lt;div
                          className="card-header"&gt; &lt;div
                          className="header-top d-sm-flex
                          align-items-center"&gt; &lt;h5&gt;User
                          Activations&lt;/h5&gt; &lt;div
                          className="center-content"&gt; &lt;p&gt;Yearly User
                          24.65k&lt;/p&gt; &lt;/div&gt; &lt;div
                          className="setting-list"&gt; &lt;ul
                          className="list-unstyled setting-option"&gt;
                          &lt;li&gt; &lt;div className="setting-primary"&gt;
                          &lt;i className="icon-settings"&gt;&lt;/i&gt;
                          &lt;/div&gt; &lt;/li&gt; &lt;li&gt; &lt;i
                          className="view-html fa fa-code
                          font-primary"&gt;&lt;/i&gt; &lt;/li&gt; &lt;li&gt;
                ...
                <div className="card trasaction-sec">
                  ...
                  <div className="card-body p-0">
                    ...
                    <div className="code-box-copy">
                      ...
                      <pre>
                        {/* <code className="language-html" id="transaction">
                          &lt;div className="card trasaction-sec"&gt; &lt;div
                          className="card-header"&gt; &lt;div
                          className="header-top d-sm-flex
                          align-items-center"&gt;
                          &lt;h5&gt;Transaction&lt;/h5&gt; &lt;div
                          className="center-content"&gt; &lt;p&gt;5878
                          Suceessfull Transaction&lt;/p&gt; &lt;/div&gt; &lt;div
                          className="setting-list"&gt; &lt;ul
                          className="list-unstyled setting-option"&gt;
                          &lt;li&gt; &lt;div className="setting-secondary"&gt;
                          &lt;i className="icon-settings"&gt; &lt;/i&gt;
                          &lt;/div&gt; &lt;/li&gt; &lt;li&gt; &lt;i
                          className="view-html fa fa-code
                          font-secondary"&gt;&lt;/i&gt; &lt;/li&gt; &lt;li&gt;
                          &lt;i className="icofont icofont-maximize full-card
                          font-secondary"&gt;&lt;/i&gt; &lt;/li&gt; &lt;li&gt;
                          &lt;i className="icofont icofont-minus minimize-card
                          font-secondary"&gt;&lt;/i&gt; &lt;/li&gt; &lt;li&gt;
                          ...
                          font-secondary"&gt;&lt;/i&gt; &lt;/li&gt; &lt;li&gt;
                          &lt;i className="icofont icofont-error close-card
                          font-secondary"&gt;&lt;/i&gt; &lt;/li&gt; &lt;/ul&gt;
                          &lt;/div&gt; &lt;/div&gt; &lt;/div&gt; &lt;div
                          className="transaction-totalbal"&gt; &lt;h2&gt;
                          $2,09,352k &lt;span className="ms-3"&gt; &lt;a
                          className="btn-arrow arrow-secondary" &gt; &lt;i
                          className="toprightarrow-secondary fa fa-arrow-up
                          me-2"&gt;&lt;/i&gt;98.54% &lt;/a&gt; &lt;/span&gt;
                          &lt;/h2&gt; &lt;p&gt;Total Balance&lt;/p&gt;
                          &lt;/div&gt; &lt;div className="card-body p-0"&gt;
                          &lt;div id="chart-3dash"&gt;&lt;/div&gt; &lt;/div&gt;
                          &lt;/div&gt;
                        </code> */}
                      </pre>
                    </div>
