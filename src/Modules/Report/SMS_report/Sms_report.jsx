                          ...
                          <div className="row ">
                              <div class="col-md-2">
                                <div className="form-group">
                                  ...
                                  <input type="date" value={selectedOption1} onChange={handleOption1Change} style={{marginLeft:"-20px"}}
                                    name="examID"
                                    id="examID"
                            ...
                            <div className="col-md-2">
                              <div className="form-group">
                                ...
                                >
                                  ...
                                  <option value="2">Bus Report</option>
                                  <option value="3">Campus Report</option>
                               </select>{" "}
                              </div>
                            </div>
                         <div className="col-md-2">
                            ...
                            <input className="mt-1 btn btn-success" type="button" value="View Report" aria-hidden="true" onClick={handleRenderList} style={{marginLeft:"-10px",position:"relative",top:"4px"}}/>
                            </div>
