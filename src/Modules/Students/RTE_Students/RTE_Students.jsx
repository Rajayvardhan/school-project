          ...
          <div className="table-responsive">
            <table className="table display dataTable" id="advance-1">
              <thead>
                <tr>
                  <th>sr. no</th>
                  <th><input type="checkbox" style={{position:"relative", right:"10px", top:"5px"}}/>Select All</th>
                  <th>SR No</th>
                  <th>Student Name</th>
                  <th>Father Name</th>
                  <th>Class</th>
                ...
                <div className="row">
                  <div className="col-sm-12">
                    <form
                      ...
                      role="form"
                      method="post" style={{marginTop:"-23px"}}
                    >
                      <div className="row px-3">
                        <div className="col-md-12">
                          <div className="row ">
                            ...
                            <div className="col-md-2">
                              <div className="form-group">
                                ...
                                <select value={selectedOption2} onChange={handleOption2Change} style={{marginLeft: "-5px"}}
                                  name="sectionID"
                                  id="sectionID"
                                  className="form-control select2 select2-offscreen"
                                  tabindex="-1"
                         ...
                         <div className="col-md-2">
                            ...
                            <input className=" btn btn-success" type="button" value="View Students" aria-hidden="true" onClick={handleRenderList} style={{marginLeft:"-10px",marginTop:"7px"}}/>
                            </div>
